...
| /live/arrangement_clip/get/name          | track_id, arr_clip_idx                                              | track_id, arr_clip_idx, name                                                           | Get arrangement-view clip name                                                                                                                           |
| /live/arrangement_clip/set/name          | track_id, arr_clip_idx, name                                        |                                                                                        | Set arrangement-view clip name                                                                                                                           |
